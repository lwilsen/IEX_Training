...
st.write(
    """This method uses Bayesian Inference to try to find groups of words that appear frequently together
...
st.write(
    """Here you can come up with some potential topics based on these words. For example, topic 6 could 

...
st.write("---")
st.write(
    "This dataset contains many different movie reviews which is roughly half positive reviews, and half negative reviews."
)
...
st.write(
    """As you can see, there is still some html formatting left in the original 

...
st.write(
    """The first model we're going to use for our NLP is a logistic Regression Classifier, 
...
st.write(
    """**The accuracy for this model was 89.2% on the training data, and 89.3% on the testing dataset.**
"""
)
st.write("---")
st.write("## Out-of-Core Learning with a Stochastic Gradient Descent Classifier")
st.write(
    """The previous model took a very long time to run, mostly due to the grid search performed, and 

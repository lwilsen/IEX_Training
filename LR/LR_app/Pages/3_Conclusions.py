...
def reg_mod(model, X_train=Xl_train, X_test=Xl_test, y_train=yl_train, y_test=yl_test):
    ...
    mod_dict = {"coefficients": model.coef_, "intercept": model.intercept_}
...
st.image(
    "/Users/lukewilsen/Desktop/IEX/IEX_Training/final_project/streamlit/pictures/LR_coefficient_estimates.png",

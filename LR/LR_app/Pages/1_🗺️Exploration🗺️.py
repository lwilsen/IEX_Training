...
st.write('''In this section, I wanted to explore the distribution of some of the variables, to get a 
...
st.write("""Clearly we're working with a right skewed dataset. This means that the linear regression assumption
...
st.write('''Predictably, much of the right skew in SalePrice we observed earlier comes from homes with central
         air conditioning.''')

fig = px.scatter(df,x = 'Overall Qual',y = 'SalePrice', color = 'Fireplaces', opacity = 0.5,
